...
import 'package:location_picker_flutter_map/location_picker_flutter_map.dart';import '../../../../constants/constants.dart';
...
class _SearchTabState extends State<SearchTab> with AutomaticKeepAliveClientMixin<SearchTab> {
  ...
  Widget build(BuildContext context) {
    super.build(context);
    final searchedLocationsBloc = BlocProvider.of<SearchedLocationsBloc>(context, listen: false);
    return SizedBox(
        ...
        children: [
          Expanded(
            child: FlutterLocationPicker(
                ...
                onPicked: (pickedData) {
                  SearchedUpLocation location = SearchedUpLocation(name: pickedData.address,
                      longitude: "${pickedData.latLong.longitude}", latitude: "${pickedData.latLong.latitude}");
          ...
          Expanded(
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index){
                return SearchedUpLocationTile(location: state.locations[index],);
              },
            );
},
            ),
